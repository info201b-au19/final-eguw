...
Total Homeless Vets: `r sum(homeless_population_analysis$homelessVets)`
Total Homeless Under Age 18: `r sum(homeless_population_analysis$homelessU18)`
Total Homeless With Family: `r sum(homeless_population_analysis$homelessWFam)`
...
This scatterplot of *Homelessness vs Crime* was included because one of the questions that we had was if there was a correlation between homelessness and crime rates in the US. Using the scatterplot, it is easier to visualize the trends of if the correlation is positive, negative, or no correlation at all.
As you can see there is a slight positive correlation between homelessness and crime rates. 
