...
## Shelter Analysis
The visualization below illustrates the proportion of Sheltered Homeless to Unsheltered Homeless individuals, in each State in 2016. To make it even more apparent, when there's a high proportion of Unsheltered Homeless the pie chart gets larger.
